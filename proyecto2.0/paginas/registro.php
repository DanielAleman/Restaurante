        ...
        <div id="form">
            <div class='fieldset'>
                ...
                <form method="POST" name="registrar">
                    ...
                    <div class='row'>
                        <input type="number" name='txtTel' placeholder="Teléfono">
                    </div>
                    <div class='row'>
                        <input type="text" name='txtUsu' placeholder="Usuario">
                    </div>
                    <div class='row'>
                        <input type="password" name='txtCon1' placeholder="Contraseña">
                    </div>
                    <div class='row'>
                        <input type="password" name='txtCon2' placeholder="Repita contraseña">
                    </div>
