...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/tabladatos.css">
</head>
<body>
    <center>
                ...
                if($estado != 0){
                    for($rr = 0; $rr < count($datosPag); $rr++){
                        echo "<tr>";
                            ...
                            echo "<td class='o'><img src='../imagenes/".$datosPag[$rr]["IMAGEN"]."' width='10%'></td>";
                    ...
                    for($i = 1; $i < $totalPaginas; $i++){
                        if($numPagina == $i){
                            ...
                            echo "<a href='?op=platillos&pagina = $i'>$i</a>";
                        }
                    }
                }
            ?>
